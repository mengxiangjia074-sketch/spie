...
def _create_sam3_model(
    ...
    if not eval_mode:
        try:
            ...
            raise ImportError(
                "Training-only SAM3 matcher modules are unavailable in this trimmed checkout. "
                "Inference still works with eval_mode=True, but training requires restoring sam3/train."
            ) from exc
